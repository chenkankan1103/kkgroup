...
FALLBACK_TRENDS = [
    {
        'topic': '2026年',
        'search_volume': 15000,
        'increase_percentage': 1200,
        'category': '搜尋',
    },
    {
        'topic': '春節',
        'search_volume': 12500,
        'increase_percentage': 850,
        'category': '季節',
    },
    {
        'topic': '台灣',
        'search_volume': 11200,
        'increase_percentage': 650,
        'category': '地區',
    },
    {
        'topic': '天氣',
    ...
    },
    {
        'topic': 'Google',
        'search_volume': 9800,
        'increase_percentage': 380,
        'category': '網路',
    },
    {
        'topic': 'Discord',
        'search_volume': 8900,
        'increase_percentage': 320,
        'category': '遊戲',
    },
    {
        'topic': 'Python',
        'search_volume': 8200,
        'increase_percentage': 290,
        'category': '程式',
    },
    {
        'topic': 'AI',
        'search_volume': 7600,
        'increase_percentage': 260,
        'category': '科技',
    },
    {
        'topic': '遊戲',
        'search_volume': 7100,
        'increase_percentage': 240,
        'category': '娛樂',
    },
]
    ...
    try:
        ...
        for engine_config in SERPAPI_ENGINES:
            try:
                ...
                search_params = {'engine': engine, **engine_params}
...
def format_trends_text(trends: List[Dict]) -> str:
    ...
    for idx, t in enumerate(trends[:10], 1):
        lines.append(
            f"{idx}. {t['topic']} | 搜索: {t['search_volume']:,} | 增長: +{t['increase_percentage']}%"
        )
...
def format_lottery_embed(
    ...
    """
    if not trends:
        return discord.Embed(title='❌ 暫無數據', color=discord.Color.red())
    ...
    embed.add_field(name='🔥 熱門趨勢排行', value=trends_field_value or '無數據', inline=False)
    ...
    embed.add_field(name='🎁 中央彩池', value=pool_display, inline=False)
