    ...
    try:
        ...
        try:
            ...
            if dashboard_ready:
                ...
                # 註冊持久化按鈕視圖
                client.add_view(DashboardButtons("uibot", client))
                print("✅ 控制面板按鈕已註冊")
            ...
            await ensure_dashboard_messages(client, "uibot")
            
            # 註冊機器人實例供日誌更新使用
            from status_dashboard import register_bot_instance
            register_bot_instance("uibot", client)
        except Exception as e:
        ...
        # ============================================================
        try:
            add_log("uibot", "✅ 啟動資訊已發送到 Webhook")
        except Exception as e:
