...
# UI 模組清理清單
UI_COMMANDS = {
    "cogs/ui/anime_tracker.py": ["anime_status", "anime_start"],
    "cogs/ui/anti_advertising.py": ["ad_violations", "ad_settings", "unmute", "clear_violations", "cross_channel_status", "emergency_cleanup"],
    "cogs/ui/ScamParkEvents.py": ["event_stats", "event_reset", "event_force"],
    "cogs/ui/id_diagnosis.py": ["check_user_ids", "list_id_issues"],
    "cogs/locker_event_test.py": ["test_locker_equipment", "test_locker_currency", "test_locker_health", "test_locker_full_refresh"],
    "cogs/commands/character_setup.py": ["set_character", "view_character", "random_character"],
}

print("=" * 70)
print("開始刪除 UI 模組的過時指令 (20個)")
print("=" * 70)
...
for filepath, commands in UI_COMMANDS.items():
    print(f"\n📄 {filepath}")
